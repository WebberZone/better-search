...
if ( ! class_exists( 'Better_Search_Query' ) ) :
	...
	class Better_Search_Query extends WP_Query {
		...
		public function __construct( $args = array() ) {
			...
			add_filter( 'better_search_query_posts_request', array( $core_query, 'set_topscore' ), 99999, 2 );
			...
			remove_filter( 'better_search_query_posts_request', array( $core_query, 'set_topscore' ), 99999 );
